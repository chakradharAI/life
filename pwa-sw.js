...
const OFFLINE_PAGE = 'http://localhost/test1/';
const NOT_FOUND_PAGE = 'http://localhost/test1/';
...
//    (str) => {
//        return !str.includes('/wp-admin/') || !str.startsWith('http://localhost/test1//wp-admin/');
//    },
];
